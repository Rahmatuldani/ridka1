<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css1/card1.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css1/title1.css') }}">
    ...
    <style type="text/css">
        body {
            background-image: url("{{ asset('uploads/kk.jpeg') }}");
...
<body>
  ...
  {{-- <div class="card bg-secondary">
    <img src="http://monitorpegawai.semarangkota.go.id/foto/avatar.png" alt="Person" class="card__image">
    <a href="{{url('/user')}}"><button class="btn draw-border">PETUGAS</button></a>
  </div> --}}
