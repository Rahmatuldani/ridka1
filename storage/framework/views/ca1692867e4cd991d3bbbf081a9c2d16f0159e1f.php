      ...
      >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            <li><a href="<?php echo e(route('logout')); ?>" class="btn btn-dark">Logout</a></li>
      ...
      <div class="wrapper d-flex">
        <div class="sideMenu bg-mattBlackLight" style="margin-top: 5%">
          <div class="sidebar">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a href="<?php echo e(route('admin.index')); ?>" class="nav-link px-2">
                  <i class="material-icons icon">
                    dashboard
                  </i>
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('loc.index')); ?>" class="nav-link px-2">
                  <i class="material-icons icon"> insert_chart </i
                  ><span class="text">Input Lokasi</span></a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('outkar')); ?>" class="nav-link px-2">
                  <i class="material-icons icon">
                    settings
                  </i>
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('outloc')); ?>" class="nav-link px-2">
                  <i class="material-icons icon">
                    settings
                  </i>
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('riwayat')); ?>" class="nav-link px-2">
                  <i class="material-icons icon">
                    pages
                  </i>
               ...
               <li class="nav-item">
                <a href="<?php echo e(route('barcode')); ?>" class="nav-link px-2">
                  <i class="material-icons icon">
                    pages
                  </i>
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('/rekap')); ?>" class="nav-link px-2">
                  <i class="material-icons icon">
                    pages
                  </i>
              ...
              <form action="<?php echo e(route('user.store')); ?>" method="POST" enctype="multipart/form-data" >
                <?php echo csrf_field(); ?>
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nip" id="add_nip"
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" name="pos" id="add_pos">
                  ...
                  <input class="btn btn-danger" type="submit" name="upload" value="Submit">
                  </div>
...
<?php /**PATH E:\ridka-master\resources\views/admin.blade.php ENDPATH**/ ?>