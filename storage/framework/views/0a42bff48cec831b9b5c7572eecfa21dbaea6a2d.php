            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid m-3">
                        ...
                        <h1 class="h3 mb-4 text-gray-800" align="center"><?php echo e($date); ?></h1>
                                ...
                                <table class="table">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr>
                                        ...
                                        <td>
                                            <img src="<?php echo e(asset('/images/'.$d['foto'])); ?>" alt="foto" width="100">
                                        </td>
                                      </tr>
                                      <?php $no = $no + 1; ?>
...
<?php /**PATH E:\Ridka\resources\views/prekap.blade.php ENDPATH**/ ?>